...
class ChromeNegativeTests(unittest.TestCase):
    ...
    def test_add_item_to_cart_chrome(self):
        ...
        wait.until(EC.visibility_of_element_located(
            (By.XPATH,
             "//a[@href='/product/cybertruck-elevate-backpack?sku=1990496-00-A'][contains(.,'Cybertruck Elevate Backpack')]")))
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,
                            "//a[@href='/product/cybertruck-elevate-backpack?sku=1990496-00-A'][contains(.,'Cybertruck Elevate Backpack')]").click()
        time.sleep(2)
        first_window = driver.window_handles[0]
        all_windows = driver.window_handles
        for window in all_windows:
    ...
    def test_add_item_to_lifestyle_cart_chrome(self):
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,
                            "//a[@href='/product/cyberstein?sku=1949545-00-A'][contains(.,'CyberStein')]").click()
        time.sleep(2)
        first_window = driver.window_handles[0]
        all_windows = driver.window_handles
        for window in all_windows:
